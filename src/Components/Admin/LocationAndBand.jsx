...
const LocationAndBand = (e) => {
  ...
  return (
    <div className="bg-yellow-100 w-full h-screen overflow-x-auto">
      ...
      <div className="flex flex-col sm:flex-row gap-4 ml-2 justify-evenly mt-10">
        <div className="h-fit p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 mb-10 dark:border-gray-700">
          <div className="flex w-full">
            <button
              className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-3 rounded-full mb-4 flex self-center justify-end"
              onClick={addband}
            >
              Add Band
            </button>
        ...
        <div className="h-fit p-4 bg-white border mb-10 border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
          <div className="flex w-full">
            <button
             className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-3 rounded-full mb-4 flex self-center justify-end"
              onClick={addlocation}
