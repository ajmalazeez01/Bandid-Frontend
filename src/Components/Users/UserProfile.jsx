              ...
              <div className="w-[40rem] h-[32rem] my-32 mb-6 bg-gray-900 rounded-lg ml-4 border-2">
                ...
                <div className="grid w-[38rem] h-50 pb-4 pt-2 pl-4 pr-4 bg-yellow-100 ml-4 rounded-lg mb-44 grid-cols-2 gap-4 ">
                  ...
                  {loadingButton ? (
                    <button
                      disabled
                      className="mb-3 text-white w-6/12 mx-56 mt-2 rounded-md p-2.5 text-base font-medium bg-gradient-to-br from-pink-500 to-orange-400 hover:bg-gradient-to-bl"
                    >
                      Loading...
                    </button>
                  ) : (
